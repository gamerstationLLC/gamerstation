...
<div aria-hidden className="pointer-events-none absolute inset-0">
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/60 to-black" />
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        {/* Hero */}
        <section className="mt-5 grid gap-8 lg:mt-14 lg:grid-cols-2 lg:items-center lg:gap-10">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-neutral-800 bg-black/70 px-3 py-1 text-[11px] text-neutral-300 transition hover:border-neutral-600 hover:bg-black/90 sm:text-xs">
              <span className="h-2 w-2 rounded-full bg-white/70" />
              Live calculators • Fast results • Clean UI
            </div>

            <h2 className="mt-5 text-xl font-bold tracking-tight sm:text-3xl">
              Multi-game calculators <span className="text-neutral-300">&</span> stats tools.
            </h2>

            <p className="mt-4 max-w-xl text-sm text-neutral-300 sm:text-base">
              One hub for high-signal tools: <span className="text-white">TTK</span>, sensitivity, drop odds, XP, and
              more — with a patchwatch feed for buffs/nerfs.
            </p>
            ...
            <div className="mt-6 grid grid-cols-3 gap-2 sm:hidden">
              {[
                ...
                <div key={k} className="rounded-xl border border-white/10 bg-white/5 px-2 py-2">
                  <div className="text-[10px] leading-none text-neutral-400">{k}</div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-6">
              ...
              <div className="mt-4 grid gap-3 sm:mt-6 sm:gap-4">
                ...
                >
                  ...
                  <div className="mt-2 text-xs text-neutral-400">Weapons dropdown + Warzone plates.</div>
                  <div className="mt-2 text-xs text-neutral-400">Patchwatch feed for expected balance changes.</div>
                </Link>
        ...
        <footer className="mt-16 border-t border-neutral-800 pt-6 text-center text-xs text-neutral-500">
          <div className="space-y-3">
            <p>
              GamerStation is not affiliated with or endorsed by Activision, Epic Games, Riot Games, or any game
              publishers. All trademarks belong to their respective owners.
            </p>
            ...
            <p className="text-[11px] text-neutral-600">© {new Date().getFullYear()} GamerStation</p>
          </div>
        </footer>
      </div>
    </main>
