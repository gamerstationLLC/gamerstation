    ...
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-10 sm:py-14">
        ...
        <header className="flex items-center justify-between">
          {/* LOGO replaces GamerStation text (top-left) */}
...
/>
          ...
          <nav className="flex items-center gap-3 text-sm">
            <Link
              href="/calculators"
              className="rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-neutral-200 backdrop-blur hover:bg-white/10 hover:text-white"
            >
              Calculators
          </Link>
            <button
  ...
  Compare (Coming soon)
        ...
        <section className="mt-14 grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            {/* Micro stats row */}
            <div className="mt-15 grid max-w-xl grid-cols-3 gap-3">
          ...
          <div className="relative">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
              <div className="flex items-center justify-between">
                ...
                <div className="rounded-full border border-white/10 bg-black/40 px-3 py-1 text-xs text-neutral-300">
                  v0.1
                </div>
              </div>
              ...
              <div className="mt-6 grid gap-4">
                <Link
                  ...
                  className="group rounded-2xl border border-white/10 bg-black/40 p-5 hover:border-white/20"
                >
                  <div className="flex items-center justify-between">
...
<Link
  ...
  className="group block rounded-2xl border border-white/10 bg-black/40 p-5 hover:border-white/20 transition"
>
  <div className="flex items-center justify-between">
